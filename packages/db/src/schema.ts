import { pgTable, uuid, text, bigint, boolean, time, timestamp, index } from "drizzle-orm/pg-core";
...
export const notes = pgTable("notes", {
  ...
  index("idx_notes_user_status_due").on(table.userId, table.status, table.dueAt),
